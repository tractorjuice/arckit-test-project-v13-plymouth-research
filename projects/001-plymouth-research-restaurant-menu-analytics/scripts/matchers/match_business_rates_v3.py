#!/usr/bin/env python3
"""
Business Rates Matcher V3 - Improved with Name Normalization

Improvements:
- Strips corporate suffixes (LTD, LIMITED, PLC, HOLDINGS)
- Strips location suffixes (Plymouth, UK)
- Removes special characters and punctuation
- Lowered confidence threshold from 70% to 55%
...
OUTPUT_CSV_CONFIDENT = 'business_rates_matches_confident_v3.csv'
OUTPUT_CSV_ALL = 'business_rates_matches_all_v3.csv'
OUTPUT_CSV_UNMATCHED = 'business_rates_unmatched_v3.csv'
...
def main():
    print("=" * 80)
    print("BUSINESS RATES MATCHER V3 - IMPROVED WITH NAME NORMALIZATION")
    print("=" * 80)
    print()
    print("Improvements:")
    ...
    print("  ✓ Lowered confidence threshold: 55% (was 70%)")
    print()
