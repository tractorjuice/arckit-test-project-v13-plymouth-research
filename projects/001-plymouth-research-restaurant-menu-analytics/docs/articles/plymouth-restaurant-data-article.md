...
| Papa John's Plymouth | 5 | 1.88 | 3.12 |
| McDonald's Plymouth | 5 | 1.89 | 3.11 |
| Domino's Pizza Plymouth | 5 | 1.95 | 3.05 |
| Pizza Hut Plymouth | 5 | 1.99 | 3.01 |
| Burger King Plymouth | 5 | 2.04 | 2.96 |

The best performers in our dataset are the ones you might expect: restaurants where a real chef is cooking real food to order. Rockfish Plymouth managed an FSA 5 alongside a Trustpilot score of 3.75 — not spectacular, but head and shoulders above the chains. Armado Lounge followed at 3.45 on Trustpilot, again with a perfect hygiene record.
...
At the top end, Plymouth's fine dining and Michelin-associated restaurants averaged £24.38 per item. Wine bars and small plates venues came in at £22.36, though the "per item" framing matters here — small plates are designed to be ordered in multiples. Seafood and fish restaurants, a category with a substantial 123 items in our sample, averaged £11.21. Italian cuisine (195 items) sat at £9.74, and Japanese food (183 items) came in at a similar £9.53.
