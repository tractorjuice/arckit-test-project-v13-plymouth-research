...
| 1.2 | 2026-03-08 | AI Agent | Refreshed against `ARC-001-RSCH-v2.1`. Reconfirmed GitHub-native automation as the preferred path for weekly refresh, CI, and dependency scanning. | PENDING | PENDING |
