...
def main():
    ...
    xml_path = Path(__file__).parent / "plymouth_fsa_data.xml"
    ...
    if unmatched:
        unmatched_file = Path(__file__).parent / "unmatched_hygiene_ratings.csv"
    ...
    if matched_details:
        matched_file = Path(__file__).parent / "matched_hygiene_ratings.csv"
